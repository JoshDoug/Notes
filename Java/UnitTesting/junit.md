...
Builds on many of the assertions that JUnit 4 has and adds a few that work well with lambdas. All JUnit Jupiter assertions are `static` methods in the [`org.junit.jupiter.Assertions`](http://junit.org/junit5/docs/current/api/org/junit/jupiter/api/Assertions.html) class.

Example from JUnit 5's user guide:
